...
| `ACCOUNT_CONFIG_UPDATE` | Leverage/margin mode changes | On change |
...
> **CONSTRAINT**: You MUST copy the `connectCoinmWsAccount` function below verbatim
